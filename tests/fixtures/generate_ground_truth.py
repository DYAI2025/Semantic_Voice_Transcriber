...
def main():
    ...
    print("=" * 80)
    print(f"\nGenerated files:")
    print(f"  1. test_2speakers_clear.wav      - 2 speakers, clear, no overlap")
    print(f"  2. test_2speakers_overlap.wav    - 2 speakers, with overlaps")
    print(f"  3. test_3speakers_clear.wav      - 3 speakers, clear")
    print(f"  4. test_2speakers_noisy.wav      - 2 speakers, 10dB SNR")
    print(f"  5. test_single_speaker.wav       - 1 speaker (edge case)")
